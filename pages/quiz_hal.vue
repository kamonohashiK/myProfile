<template>
  <v-layout column justify-center align-center>
    ...
    <v-col cols="12" sm="6">
      <a href="https://apps.apple.com/jp/app/quiz-high-low/id1597468227?itsct=apps_box_badge&amp;itscg=30200" target="_blank" style="display: inline-block; overflow: hidden; border-radius: 13px; width: 250px; height: 83px;"><img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/ja-jp?size=250x83&amp;releaseDate=1645056000&h=864a697db6d2b385a110f89dbbaa6a7a" alt="Download on the App Store" style="border-radius: 13px; width: 250px; height: 83px;"></a>
      <a href='https://play.google.com/store/apps/details?id=com.kamoya86.quiz_hal&pcampaignid=pcampaignidMKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1' target="_blank"><img alt='Google Play で手に入れよう' src='https://play.google.com/intl/us-en/badges/static/images/badges/ja_badge_web_generic.png' style="height:100px;"></a>
    </v-col>

    <span style="margin:20px;"></span>

    <strong id="privacy_policy_ja">Quiz High&amp;Low プライバシーポリシー</strong>
    <p>
      Quiz High&Lowは、広告付きアプリです。本サービスは、かも屋が無償で提供するものであり、そのままの状態でご利用いただくことを前提としています。
    </p>
    <p>
      このページは、お客様が本サービスをご利用になる際に、個人情報の収集、利用、開示についての方針をお知らせするためのものです。
    </p>
    <p>
      お客様が当サービスを利用する場合、このポリシーに関連する情報の収集と使用に同意したことになります。私が収集した個人情報は、本サービスの提供および改善のために使用されます。私は、本プライバシーポリシーに記載されている場合を除き、お客様の情報を誰かと使用または共有することはありません。
    </p>
    <p>
      本プライバシーポリシーで使用されている用語は、別途定義されていない限り、Quiz High&Lowでアクセス可能な当方の規約と同じ意味を持ちます。
    </p>
    <p><strong>情報の収集と利用</strong></p>
    <p>
      本サービスをより快適にご利用いただくために、お客様から個人情報の提供をお願いすることがあります。私が要求する情報は、お客様のデバイスに保持され、私が何らかの方法で収集することはありません。
    </p>
    <div>
      <p>
    ...
    <p><strong>ログデータの収集</strong></p>
    <p>
      お客様が私のサービスをご利用になる際、アプリにエラーが発生した場合、私はログデータと呼ばれるお客様の携帯電話のデータや情報を（第三者の製品を通じて）収集することをお知らせします。このログデータには、お客様の端末のインターネットプロトコル（IP）アドレス、端末名、オペレーティングシステムのバージョン、本サービスを利用する際のアプリの設定、本サービスを利用した日時、その他の統計情報などが含まれる場合があります。
    </p>
    <p><strong>クッキー</strong></p>
    <p>
      クッキーとは、少量のデータを記録したファイルで、一般的に匿名の固有識別子として使用されます。これらは、お客様が訪問するウェブサイトからお客様のブラウザに送信され、お客様のデバイスの内部メモリに保存されます。
    </p>
    <p>
    ...
    <p>このポリシーは、2021年11月25日より有効です。</p>
    <p><strong>お問い合わせ</strong></p>
    <p>
      私のプライバシーポリシーについてご質問やご提案がある場合は、遠慮なく quiz.hal.dev@gmail.com までご連絡ください。
    </p>
    <p>
      このプライバシーポリシーページは、
      <a
      ...
      >
      によって修正／生成されたものを翻訳したものです。
    </p>

    <strong id="privacy_policy_en">Quiz High&amp;Low Privacy Policy</strong>
    <p>
      Kamoya built the Quiz High&amp;Low app as an Ad Supported app. This
      SERVICE is provided by Kamoya at no cost and is intended for use as is.
    </p>
    <p>
    ...
    <p>
      ...
      Terms and Conditions, which are accessible at Quiz High&amp;Low unless
    ...
    <p>This policy is effective as of 2021-11-25</p>
    <p><strong>Contact Us</strong></p>
    <p>
      If you have any questions or suggestions about my Privacy Policy, do not
      hesitate to contact me at quiz.hal.dev@gmail.com.
    </p>
    <p>
